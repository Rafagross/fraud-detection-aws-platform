...
# Wires together all platform modules in dependency order.
...
# 4. EC2 workload — creates the workload SG needed by vpc-endpoints
module "ec2_workload" {
  ...
  vpce_sg_id             = module.vpc_endpoints.vpce_sg_id
